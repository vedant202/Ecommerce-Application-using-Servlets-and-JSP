...
<body>
	<div>
		...
		<button>
			<a href="/FilterTuts/admin/add_product">Add Product</a>
		</button>
		...
		<div class="tableDiv">
			<table border="0 0 1px solid" class="table">
				...
				<thead>
					<tr>
						<th style="text-align: center;" colspan="5"><h1>ALL
								PRODUCTS</h1></th>
						<th>
							<div class="cateList" id="cateList" tabindex="100">
								...
								<ul class="items" id="cateItems">
									...
									<li><input type="checkbox" />Whiskey</li>
									<li><input type="checkbox" />Grocery</li>
								</ul>
							</div>
						</th>
